...
import petrolpark.mc.destroy.core.seismology.DestroySeismologyProviders;
...
public class DestroyItems {
    ...
    public static final ItemEntry<SeismographItem> SEISMOGRAPH = Destroy.REGISTRATE.item("seismograph", SeismographItem::new)
        .defaultLang()
        .defaultModel()
        .properties(p -> p
            .stacksTo(1)
            .component(DestroyDataComponentTypes.SEISMOLOGY_PROVIDER, DestroySeismologyProviders.NONE.get())
            .component(DestroyDataComponentTypes.SEISMOGRAPH, Seismograph.empty())
        ).register();

    public static final ItemEntry<SeismometerItem> SEISMOMETER = Destroy.REGISTRATE.item("seismometer", SeismometerItem::new)
