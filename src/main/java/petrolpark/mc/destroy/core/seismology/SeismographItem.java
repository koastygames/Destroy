...
public class SeismographItem extends MapItem {
    ...
    public static class Seismograph {
        ...
        public static enum Mark {
            NONE(null),
            TICK(DestroyGuiTexture.SEISMOGRAPH_TICK),
            CROSS(DestroyGuiTexture.SEISMOGRAPH_CROSS),
            GUESSED_TICK(DestroyGuiTexture.SEISMOGRAPH_GUESSED_TICK),
            GUESSED_CROSS(DestroyGuiTexture.SEISMOGRAPH_GUESSED_CROSS);

            @Nullable
            public final DestroyGuiTexture icon;

            private Mark(DestroyGuiTexture icon) {
                this.icon = icon;
            };
        };
    };
