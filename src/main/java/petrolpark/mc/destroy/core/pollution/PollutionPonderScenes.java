...
// import petrolpark.mc.library.destroy.chemistry.minecraft.MixtureFluid;
// import petrolpark.mc.library.destroy.client.DestroyParticleTypes;
// import petrolpark.mc.library.destroy.core.fluid.RainParticle;
// import petrolpark.mc.library.destroy.core.fluid.gasparticle.GasParticleData;
...
//         for (int i = 0; i < 200; i++) {
//             scene.idle(1);
//             scene.addInstruction(new SmogPonderInstruction(i * PollutionHelper.getChunkPollutionTypeProperties(DestroyPollutionTypes.SMOG.get()).max() / 200));
//         };
//         scene.markAsFinished();
//     };
...
//         scene.effects().emitParticles(util.vector().blockSurface(pos, Direction.DOWN).add(0, 0.25f, 0), scene.effects().particleEmitterWithinBlockSpace(PollutionHelper.getCropGrowthFailureParticles(), Vec3.ZERO), 10f, 1);
//     };
